...
parser.add_argument('--d', default=0.00001, type=float, help='weight decay')
parser.add_argument('--tconv', default=200, type=int, help='batchsize')
parser.add_argument('--tinv', default=2000, type=int, help='batchsize')
...
trainset = torchvision.datasets.CIFAR10(root='/home/sunying/data/cifar10/', train=True, download=True, transform=transform_train)
...
testset = torchvision.datasets.CIFAR10(root='/home/sunying/data/cifar10/', train=False, download=True, transform=transform_test)
...
exp_lr_scheduler = lr_scheduler.CosineAnnealingLR(optimizer, T_max=args.epochs, eta_min=args.lr*0.001)
